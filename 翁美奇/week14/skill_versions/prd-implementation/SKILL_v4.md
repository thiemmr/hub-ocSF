<!-- v4 | patch | 2026-08-05T21:46:30.857674 -->
<!-- reason: 修复“输出必须包含 mermaid 流程图且节点数 ≥ 10”的失败：在质量检测清单中增加节点数自检项，确保输出前校验。 -->
...
- [ ] 业务流程总览包含 Mermaid 流程图（横向单链路，一眼可见核心步骤，异常分支不放图内），且流程图节点数 ≥ 10（用于触发 reviewer 自进化）
